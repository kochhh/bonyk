...
const settings = {
  ...
  't-modal': {
    ...
    props: {
      ...
      classes: {
        ...
        body: '',
        header: 'bg-gray-100 order-gray-200 font-semibold',
        footer: 'bg-gray-100 border-t border-gray-200',
        close: 'bg-gray-100 border border-gray-300 shadow-sm text-gray-600 hover:bg-gray-200',
        closeIcon: 'fill-current h-4 w-4',
        overlayEnterClass: '',
  ...
  't-modal-form': {
    ...
    props: {
      ...
      classes: {
        ...
        modal: 'bg-white shadow',
        body: '',
        header: 'bg-gray-100 border-gray-200 font-semibold',
        footer: 'bg-gray-100 border-t border-gray-200',
        close: 'bg-gray-100 border border-gray-300 shadow-sm text-gray-600 hover:bg-gray-200',
        closeIcon: 'fill-current h-4 w-4',
        overlayEnterClass: '',
  ...
  't-dialog': {
    ...
    props: {
      fixedClasses: {
        overlay: 'overflow-auto scrolling-touch left-0 top-0 bottom-0 right-0 w-full h-full fixed z-40 bg-opacity-50 focus:outline-none',
        wrapper: 'relative',
