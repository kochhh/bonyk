...
const settings = {
  ...
  //   props: {
  //     fixedClasses: {
  //       wrapper: 'relative inline-flex flex-shrink-0 cursor-pointer',
  //       wrapperChecked: 'relative inline-flex flex-shrink-0 cursor-pointer border-2 border-transparent focus:ring-2 focus:ring-green-500 focus:outline-none focus:ring-opacity-50',
  //       wrapperDisabled: 'relative inline-flex flex-shrink-0 cursor-pointer opacity-50 cursor-not-allowed',
  //       wrapperCheckedDisabled: 'relative inline-flex flex-shrink-0 cursor-pointer opacity-50 cursor-not-allowed border-2 border-transparent focus:ring-2 focus:ring-green-500 focus:outline-none focus:ring-opacity-50',
  ...
  //     },
  //     classes: {
  //       wrapper: 'bg-gray-200 rounded-full border-2 border-transparent focus:ring-2 focus:ring-green-500 focus:outline-none focus:ring-opacity-50',
  //       wrapperChecked: 'bg-green-500 rounded-full',
  //       wrapperDisabled: 'bg-gray-200 rounded-full border-2 border-transparent focus:ring-2 focus:ring-green-500 focus:outline-none focus:ring-opacity-50',
  //       wrapperCheckedDisabled: 'bg-green-500',
  ...
  't-modal': {
    ...
    props: {
      ...
      classes: {
        ...
        body: '',
        header: 'bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-500 font-semibold',
        footer: 'bg-gray-100 dark:bg-gray-700 border-gray-200 dark:border-gray-500',
        close: 'bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 shadow-sm text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-900',
        closeIcon: 'fill-current h-4 w-4',
        overlayEnterClass: '',
  ...
  't-dialog': {
    ...
    props: {
      fixedClasses: {
        overlay: 'overflow-auto scrolling-touch left-0 top-0 bottom-0 right-0 w-full h-full fixed z-40 bg-opacity-60 focus:outline-none',
        wrapper: 'relative',
      ...
      classes: {
        ...
        wrapper: 'z-50 w-full sm:w-96 max-w-sm px-3 py-12 flex-shrink-0',
        dialog: 'bg-white dark:bg-gray-800 shadow rounded text-left',
        ...
        textWrapper: 'w-full mt-4 text-sm',
        text: '',
        ...
        overlayLeaveClass: 'transition ease-in opacity-100',
        overlayLeaveActiveClass: '',
        overlayLeaveToClass: 'opacity-0 duration-100',
        enterClass: '',
        enterActiveClass: '',
        enterToClass: '',
        leaveClass: '',
  ...
  't-pagination': {
    ...
    props: {
      classes: {
        wrapper: 'pagination inline-flex text-center my-4 shadow-sm ml-px',
        element: '-ml-px',
        activeElement: '-ml-px',
        ...
        ellipsis: 'w-8 h-8 inline-block border border-gray-200 dark:border-gray-700'
      },
      // variants: {
      //   rounded: {
