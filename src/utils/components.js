  ...
  't-modal': {
    ...
    props: {
      ...
      classes: {
        ...
        close: 'bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 shadow-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900',
        closeIcon: 'fill-current h-4 w-4',
        overlayEnterClass: '',
