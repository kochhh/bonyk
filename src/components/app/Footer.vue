<template>
  <footer class="bg-gray-100 border-t border-gray-300 fixed bottom-0 left-0 w-full">
    <div class="container mx-auto">
      ...
      >
        ...
        <div v-if="isSession" class="ml-auto">
          <span class="flex items-center bg-green-500 text-white py-1 pl-1 pr-2 rounded-sm text-xs">
