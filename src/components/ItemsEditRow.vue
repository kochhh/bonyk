  ...
  <tr>
    ...
    <td class="px-3 py-2 whitespace-nowrap">
      <div class="flex space-x-2" v-if="!editing">
        <button type="button" class="btn btn-green py-1 px-3 shadow-none" @click="editHandler" title="Редактировать">
      ...
      <div class="flex space-x-2" v-else>
        <button type="submit" class="btn btn-green py-1 px-3 shadow-none" @click="okHandler" title="OK">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="w-4 h-4" fill="currentColor" viewBox="0 0 16 16">
            <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
          </svg>
        </button>
        <button type="button" class="btn btn-red py-1 px-3 shadow-none" @click="cancelHandler" title="Отмена">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="w-4 h-4" fill="currentColor" viewBox="0 0 16 16">
